...
public class Main {
	...
	public static void main(String[] args){
        ...
        //uncomment the test case you would like to run
        
//------------------ Normal Execution ----------------------------------------------        

        Customer customer1 = new Customer("John", 2000);
        Cart cart1 = new Cart();
...
//        Customer customer2 = new Customer("Chloe", 2000);
//        Cart cart2 = new Cart();
//        
//        cart2.add(tv, 1);
...
//        Customer customer3 = new Customer("Jason", 2000);
//        Cart cart3 = new Cart();
//        
//        cart3.add(cheese, 1);
...
//        Customer customer5 = new Customer("Hana", 2000);
//        Cart cart5 = new Cart();
//        
